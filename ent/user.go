...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		switch columns[i] {
		case user.FieldVerified, user.FieldIsEditor, user.FieldIsLoggedIn:
			values[i] = new(sql.NullBool)
		case user.FieldID:
			values[i] = new(sql.NullInt64)
		case user.FieldName, user.FieldEmail, user.FieldPermission, user.FieldPassword:
...
func (u *User) String() string {
	...
	builder.WriteString(u.Permission)
	builder.WriteString(", ")
	...
	builder.WriteString(fmt.Sprintf("%v", u.IsLoggedIn))
	builder.WriteString(", ")
