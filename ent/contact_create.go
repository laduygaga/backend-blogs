...
func (cc *ContactCreate) SetLink(s string) *ContactCreate {
	cc.mutation.SetLink(s)
	return cc
}

// SetType sets the "type" field.
func (cc *ContactCreate) SetType(s string) *ContactCreate {
...
func (cc *ContactCreate) check() error {
	...
	if _, ok := cc.mutation.Link(); !ok {
		return &ValidationError{Name: "link", err: errors.New(`ent: missing required field "Contact.link"`)}
	}
